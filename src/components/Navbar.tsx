...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-[#5e464a] ">
            ...
            <div className="navbar-end">
                ...
                {
                    user_id ?
                        <button onClick={() => dispatch(removeUser())} className="btn border-none bg-[#3f1b1b] hover:bg-[#502323]  text-white">Logout</button>
                        :
                        <Link to={'/login'}>
                            <a className="btn bg-[#3f1b1b] hover:bg-[#5e2a2a] text-white border-none">Login</a>
                        </Link>
                }
            </div>
        </div>
