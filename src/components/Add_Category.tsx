...
const Add_Category = () => {
    ...
    return (
        <>
            <h1 className='bg-[#5e464a] text-white text-center font-bold py-2'>Add Catetegory</h1>
            <form onSubmit={handleSubmit} className="card-body">
                ...
                <div className="form-control mt-6">
                    <button className="btn bg-[#5e464a] hover:bg-[#5e464a] text-white">Add Category</button>
                </div>
            </form>
        </>
    )
