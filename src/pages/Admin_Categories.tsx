...
const Admin_Categories = () => {
  ...
  return (
    <div>
      <h1 className='bg-[#5e464a] text-white text-3xl font-bold text-center py-3'>Product Categories</h1>
      ...
      <div className="p-5">
        ...
        <div className="text-2xl mt-5 grid justify-center items-center gap-3">
          {data?.map((one: Category_Type) => <div className="w-[300px] rounded-xl flex justify-between items-center bg-[#5e464a] text-white p-2" key={one?.category_id}>
